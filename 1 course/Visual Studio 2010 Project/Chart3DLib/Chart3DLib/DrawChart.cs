...
{
    [TypeConverter(typeof(DrawChartConverter))]
    public class DrawChart
    {
        ...
        [Description("Sets the slice location."),
        Category("Appearance")]
        ...
        [Description("Specifies the number of contour lines."),
        Category("Appearance")]
        ...
        [Description("Specifies the number of interpolations."),
        Category("Appearance")]
        ...
        [Description("Indicates whether the chart should be drawn with interpolation."),
        Category("Appearance")]
        ...
        [Description("Indicates whether the chart should be drawn with color map."),
        Category("Appearance")]
        ...
        [Description("Indicates whether the hidden lines should be shown for a mesh plot."),
        Category("Appearance")]
        ...
        [Description("Specifies the color map matrix."),
        Category("Appearance")]
        public int[,] CMap
        {
            get { return cmap; }
        ...
        [Description("Selects the chart type from ChartTypeEnum enumeration."),
        Category("Appearance")]
        ...
        [Description("Selects the X, Y, or Z slice chart from SliceEnum enumeration."),
        Category("Appearance")]
        ...
        private void AddSurface(Graphics g, DataSeries ds, ChartStyle cs,
            ChartStyle2D cs2d, Axes ax, ViewAngle va, ChartLabels cl)
        {
            Pen aPen = new Pen(ds.LineStyle.LineColor, ds.LineStyle.Thickness);
            aPen.DashStyle = ds.LineStyle.Pattern;
            ...
            else if (IsInterp)
            {
                for (int i = 0; i < pts.GetLength(0) - 1; i++)
                {
                    for (int j = 0; j < pts.GetLength(1) - 1; j++)
                    {
                        ...
                        Interp(g, cs, cs2d, m, points, zmin, zmax, 1, ax, va, cl);
    ...
    public class DrawChartConverter : TypeConverter
    {
        ...
        {
            return TypeDescriptor.GetProperties(typeof(DrawChart));
        }
    }
}
